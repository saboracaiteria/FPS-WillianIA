...
export const CFG = {
  // Grama
  GRASS_TOTAL:      _isMobile ? 12000 : 40000,
  GRASS_CHUNKS:     _isMobile ? 4 : 7,
  GRASS_CHUNK_SIZE: _isMobile ? 12 : 14,
  GRASS_HEIGHT:     0.95,
  WIND_STRENGTH:    0.55,
  // Mundo
  WORLD_SIZE:       1100,
  TERRAIN_SEGS:     _isMobile ? 70 : 120,
  VIEW_DIST:        _isMobile ? 260 : 380,
  TREE_COUNT:       _isMobile ? 100 : 200,
  ROCK_COUNT:       _isMobile ? 50 : 120,
  FLOWER_COUNT:     _isMobile ? 250 : 800,
  // Sombra
  SHADOW_MAP_SIZE:  _isMobile ? 256 : 512,
  CSM_MAX_FAR:      _isMobile ? 75 : 110,
  // Inimigos
  ENEMY_COUNT:      12,
  // Render
  MAX_PIXEL_RATIO:  _isMobile ? 1.25 : 2,
